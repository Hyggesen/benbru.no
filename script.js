...
function changeLanguage () {
    document.querySelector (".body-text p").innerHTML = "Jeg er en Front-End-utvikler student med bakgrunn fra Digital Markedsføring. Jeg har en lidenskap for å skape ting. Drømmen min er å jobbe fulltid med å lage moderne, responsiv og brukervennlige nettsider og applikasjoner. Jeg vil lære alt";
    document.querySelector (".bytteKnapp p").innerHTML = "Change to English";
    document.querySelector (".bytteKnapp p").classList.add("byttTilbake");
